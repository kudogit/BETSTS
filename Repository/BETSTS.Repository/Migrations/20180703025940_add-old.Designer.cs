...
namespace BETSTS.Repository.Migrations
{
    ...
    [Migration("20180703025940_add-old")]
    partial class addold
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BETSTS.Contract.Repository.Models.User.ExchangeEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("BETSTS.Contract.Repository.Models.UserBetEntity", b =>
                {
                    ...
                    b.Property<decimal>("MoneyLostLast");
            ...
            modelBuilder.Entity("BETSTS.Contract.Repository.Models.User.ExchangeEntity", b =>
                {
                    b.HasOne("BETSTS.Contract.Repository.Models.User.AmoutEntity", "Amout")
                        .WithMany("Exchanges")
                        .HasForeignKey("AmoutId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
