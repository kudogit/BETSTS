...
namespace BETSTS.Filters.Validation
{
    public class ApiValidationActionFilterAttribute : ActionFilterAttribute
    {
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            // Response Result
            var apiErrorViewModel = new ErrorModel(ErrorCode.BadRequest, null, keyValueInvalidDictionary);
            ...
            else
            {
                context.Result = new ContentResult
                {
                    ...
                    StatusCode = context.HttpContext.Response.StatusCode,
                    Content = JsonConvert.SerializeObject(apiErrorViewModel, Core.Models.Constants.Formatting.JsonSerializerSettings)
                };
            }
        }
